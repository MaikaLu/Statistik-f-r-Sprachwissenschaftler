...
## Inline R-Code
R-Code können Sie auch direkt in den Fließtext bauen: Die Quadratwurzel von 13 ist `r sqrt(13)`. Passen Sie dabei auf, dass die verschiedenen Arten von Apostrophen, Anführungszeichnen und Akzenten in den meisten Programmiersprachen bedeutsam sind!
