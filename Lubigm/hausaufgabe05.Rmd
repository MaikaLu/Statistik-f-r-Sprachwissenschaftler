...
#überlassen.frauen.studiengawomen <- subset(d, sex == "f")ng.bw <- weight.bw <- weight.grafik.basis + geom_boxplot(aes(x="weight",y=weight))print(weight.bw) print(frauen.studiengang.bw)
...
# Berichten Sie jetzt die Mittelwerte und Standardabweichungen für die drei Gruppen. Die erste Gruppe steht hier als Muster:print( paste("Studiengang: Klinische Linguistik","Mean:",mean(klinisch$height),"SD:",klinisch.sd) )
